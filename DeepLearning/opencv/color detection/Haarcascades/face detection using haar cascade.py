...
face_classifier = cv2.CascadeClassifier(r"C:\Users\atlah\Downloads\haarcascade_frontalface_default.xml")# Load the image
image = cv2.imread(r"C:\Users\atlah\Pictures\Saved Pictures\1.webp")

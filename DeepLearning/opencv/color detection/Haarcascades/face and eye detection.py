...
face_classifier = cv2.CascadeClassifier(r"C:\Users\atlah\Downloads\haarcascade_frontalface_default.xml")
eye_classifier = cv2.CascadeClassifier(r"C:\Users\atlah\Downloads\haarcascade_eye.xml")

img = cv2.imread(r"C:\Users\atlah\Pictures\Saved Pictures\1.webp")
